...
{n:'Odin',c:'voeding',t:'cooperative',s:'hybrid',bio:5,fair:4,sust:4,lo:4,w:'https://www.odin.nl',d:'biologische supermarkt groente fruit zuivel brood eieren'},
{n:'Marqt',c:'voeding',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:5,w:'https://www.marqt.com',d:'supermarkt biologisch groente fruit vlees vis zuivel brood'},
{n:'Pieter Pot',c:'voeding',t:'steward',s:'online',bio:4,fair:4,sust:5,lo:3,w:'https://www.pieterpot.nl',d:'verpakkingsvrij groente pasta noten olie kruiden'},
...
{n:'Mud Jeans',c:'kleding',t:'steward',s:'online',bio:4,fair:5,sust:5,lo:2,w:'https://www.mudjeans.eu',d:'duurzame jeans kleding'},
...
{n:'Herenboeren',c:'markt',t:'cooperative',s:'physical',bio:5,fair:5,sust:5,lo:5,w:'https://www.herenboeren.nl',d:'boerencooperatie vlees groente melk eieren zuivel'},
...
{n:'Vandebron',c:'energie',t:'steward',s:'online',bio:null,fair:5,sust:5,lo:4,w:'https://www.vandebron.nl',d:'groene energie stroom'},
...
,{n:'Amada Zorgcollectief',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'BuurtzorgT',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'Careibu',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'De Advieswinkel',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'LTP Psychologen',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'Social Medicines',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'Team050',c:'zorg',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned zorg'}
,{n:'De Biesterhof',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'De Buurtboer',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'De Patrijs',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'De Terp',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'Lenteland',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'Regelink',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'Aarden',c:'markt',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned markt'}
,{n:'Albron',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'Blooming',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'Brownies & Downies',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'Coffeecompany',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'Hotel Casa',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'Hutten',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'SKEK',c:'horeca',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned horeca'}
,{n:'VDR Bouwgroep',c:'bouw',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned bouw'}
,{n:'TBI',c:'bouw',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned bouw'}
,{n:'Nederhout',c:'bouw',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned bouw'}
,{n:'ECOBLOQ',c:'bouw',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned bouw'}
,{n:'Tierrafino',c:'bouw',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned bouw'}
,{n:'Biosphere Solar',c:'energie',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned energie'}
,{n:'Alkemio',c:'tech',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned tech'}
,{n:'Voys',c:'tech',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned tech'}
,{n:'DataOwn',c:'tech',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned tech'}
,{n:'Enviu',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'Generous Minds',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'Berenschot',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'CE Delft',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'Monuta',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'Vanadis Uitvaartverzorging',c:'diensten',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned diensten'}
,{n:'De Groene Amsterdammer',c:'media',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned media'}
,{n:'Novamedia',c:'media',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned media'}
,{n:'Vrij Nederland',c:'media',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned media'}
,{n:'WPG Uitgevers',c:'media',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned media'}
,{n:'Time to Momo',c:'media',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned media'}
,{n:'Flynth',c:'financien',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned financien'}
,{n:'Efteling',c:'vrije_tijd',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned vrije_tijd'}
,{n:'Madurodam',c:'vrije_tijd',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned vrije_tijd'}
,{n:'Mercurius',c:'voeding',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned voeding'}
,{n:'BOOT Koffie',c:'voeding',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned voeding'}
,{n:'The Good Spice',c:'voeding',t:'steward',s:'physical',bio:3,fair:4,sust:5,lo:4,certs:['steward'],d:'steward-owned voeding'}
...
,{n:'Downeys',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Amersfoort',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/amersfoort/downey-s'}
...
,{n:'GUIDOS | De Burg',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Noord Scharwoude',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/noord-scharwoude/guido-s-de-burg'}
...
,{n:'Hugos Bistrobar',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Sint Oedenrode',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/sint-oedenrode/hugo-s-bistrobar'}
...
,{n:'Sjefs Table',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Rijen',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/rijen/sjef-s-table'}
...
,{n:'Anas Lams Dis',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Utrecht',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/utrecht/ana-s-lams-dis'}
...
,{n:'Restaurants',c:'horeca',t:'retailer',s:'physical',bio:5,fair:4,sust:4,lo:4,p:'Nederland',d:'biologisch restaurant eten',certs:['biologisch'],w:'https://www.eet.nu/nederland/restaurants'}
// VEGAN RESTAURANTS
...
const CERT_BADGES={bcorp:{l:'B Corp',e:'B',c:'#2d5a27'},steward:{l:'Steward-owned',e:'S',c:'#1a7a6e'},biologisch:{l:'Biologisch',e:'Bio',c:'#2d5a27'},vegan:{l:'Vegan',e:'V',c:'#1a7a6e'},great:{l:'Uitstekend',e:'+++',c:'#2d5a27'},good:{l:'Goed',e:'++',c:'#1a7a6e'}};
...
function CS(){
  ...
  const myInc=savedInc||inc;const myPct=savedPct||pct;const realMbrs=realMembers.filter(function(m){return m.name&&m.name!==currentUser;}).map(function(m,i){return{id:1000+i,n:m.name,i:m.income||0,p:m.pct||10};});const demoMbrs=mbrs.filter(function(d){return !realMbrs.find(function(r){return r.n===d.n;});});const all=[...demoMbrs,...realMbrs,{id:0,n:currentUser||'Jij',i:myInc,p:Math.round(myPct*100),me:true}];const pool=all.reduce((s,m)=>s+Math.round(m.i*(m.me?myPct:(m.p!==undefined?m.p/100:0.10))),0),pp=all.length?Math.round(pool/all.length):0;
...
function KA(s,q){const cat=SC.find(c=>c.id===s.c)||{e:'🛍️',c:'#c17f24'};const dm=s.w?s.w.replace('https://','').replace('http://','').replace('www.','').split('/')[0]:'';return`<div class="cc"><div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px;"><div style="display:flex;align-items:center;gap:5px;flex:1;min-width:0;"><span style="font-size:12px;flex-shrink:0;">${cat.e}</span><h3 style="font-size:13px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${HL(s.n,q)}</h3></div>${TB(s.t)}</div><p style="font-size:11px;color:var(--mu);line-height:1.6;margin-bottom:7px;flex:1;">${HL(s.d,q)}</p><div style="display:flex;gap:3px;flex-wrap:wrap;margin-bottom:6px;">${SB(s)}</div><div style="display:flex;gap:6px;align-items:center;margin-bottom:6px;font-size:10px;color:var(--mu);"><span>📍 ${s.p||'Landelijk'}</span><span>${s.s==='online'?'🌐':s.s==='physical'?'🏪':'🔀'}</span></div>${s.w?`<a href="${s.w}" target="_blank" class="sl">🔗 ${dm}</a>`:''}<div style="display:flex;gap:3px;flex-wrap:wrap;margin-top:4px;">${(s.certs||[]).map(k=>{const b=CERT_BADGES[k];return b?`<span style="font-size:9px;padding:1px 4px;border-radius:3px;background:${b.c}18;color:${b.c};">${b.e}</span>`:''}).join('')}</div></div></div>`;}
...
function ADDFUND(pid){var fm=document.getElementById('fm');fm.style.display='block';var I='width:100%;padding:7px 10px;border:1px solid var(--br);border-radius:7px;font-size:12px;background:var(--w);color:var(--tx);';fm.innerHTML='<div class="mb" onclick="if(event.target===this)document.getElementById(\'fm\').style.display=\'none\'"><div class="md"><h3 style="font-size:15px;margin-bottom:11px;">Bijdragen</h3><div style="display:grid;gap:7px;"><input id="fn" placeholder="Jouw naam *" style="'+I+'"><input id="fb" type="number" placeholder="Bedrag" min="1" style="'+I+'"><div style="display:flex;gap:6px;"><button onclick="SAVFUND('+pid+')" style="flex:1;background:var(--co);color:#fff;padding:9px;border-radius:8px;font-size:13px;border:none;cursor:pointer;">Toekennen</button><button onclick="document.getElementById(\'fm\').style.display=\'none\'" style="padding:9px 12px;border-radius:8px;border:1px solid var(--br);background:none;font-size:12px;cursor:pointer;">Annuleren</button></div></div></div></div>';}

function RH(){
  const cnt=PS.reduce((a,s)=>({...a,[s]:projs.filter(p=>p.status===s).length}),{});
  var _t=fund.reduce(function(a,x){return a+Number(x.bedrag);},0);document.getElementById('hst').innerHTML=PS.map(function(s){return'<div class="card" style="text-align:center;padding:9px;"><div style="font-size:22px;font-weight:700;color:'+STC[s]+';">'+(cnt[s]||0)+'</div><div style="font-size:9px;color:var(--mu);">'+s+'</div></div>';}).join('')+'<div class="card" style="grid-column:1/-1;padding:9px;"><div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:4px;"><div style="display:flex;gap:10px;font-size:11px;"><span>Pot <b style="color:var(--co);">'+fundpot.toLocaleString('nl-NL')+'</b></span><span>Toegezegd <b style="color:#b85450;">'+_t.toLocaleString('nl-NL')+'</b></span><span>Vrij <b style="color:#2d5a27;">'+(Math.max(0,fundpot-_t)).toLocaleString('nl-NL')+'</b></span></div><button onclick="SETPOT()" style="font-size:10px;padding:3px 8px;border-radius:6px;border:1px solid var(--co);color:var(--co);background:none;cursor:pointer;">Instellen</button></div></div>';
...
async function LD(){
  if(!_DB)return;
  try{const{data:pd,error:pe}=await _DB.from('projects').select('*').order('created_at',{ascending:false});if(pe)console.error('projects:',pe.message);else if(pd)projs=pd.map(p=>({...p,desc:p.description}));}catch(e){console.error('projects error:',e);}
  try{const{data:sd}=await _DB.from('supporters').select('*').order('created_at',{ascending:false});if(sd&&sd.length){supporters=sd;}else{try{const ls=localStorage.getItem('fs_sup');if(ls)supporters=JSON.parse(ls);}catch(e){}}}catch(e){console.error('supporters error:',e);}
  try{const{data:fd}=await _DB.from('fund').select('*');if(fd)fund=fd;}catch(e){console.error('fund error:',e);}
  try{const{data:fp}=await _DB.from('fund_pot').select('*').limit(1);if(fp&&fp[0])fundpot=+fp[0].startbedrag;}catch(e){console.error('fund_pot error:',e);}
  RH();ROS();
  loadRealMembers().then(function(){CS();}).catch(function(){});
  console.log('LD klaar: projs='+projs.length+' supporters='+supporters.length);
}
...
function GOTO_SUPP(id){G('caring');setTimeout(function(){CT(2);setTimeout(function(){EDSUPP(id);},150);},100);}

function EDPROJ(id){
  var p=projs.find(function(x){return x.id===id;});if(!p)return;
  var f=document.getElementById('hf');f.style.display='block';
  ...
  f.innerHTML='<div class="card" style="border:1px solid #5b4fa8;"><h3 style="font-size:13px;margin-bottom:10px;color:#5b4fa8;">Project bewerken</h3>'
    ...
    +'<input id="pn" value="'+p.name+'" placeholder="Naam *" style="width:100%;padding:6px 10px;border:1px solid var(--br);border-radius:7px;font-size:12px;background:var(--w);color:var(--tx);">'
    +'<input id="pi" value="'+(p.ind||'')+'" placeholder="Indiener(s)" style="width:100%;padding:6px 10px;border:1px solid var(--br);border-radius:7px;font-size:12px;background:var(--w);color:var(--tx);">'
    +'<textarea id="pd" style="width:100%;padding:6px 10px;border:1px solid var(--br);border-radius:7px;font-size:12px;background:var(--w);color:var(--tx);min-height:60px;">'+(p.desc||'')+'</textarea>'
    ...
    +'</div><div style="margin:8px 0 6px;font-size:11px;font-weight:600;color:var(--mu);">Benodigde ondersteuning:</div>'
    +'<div id="hn-btns"></div>'
    ...
    +'</div></div>';
  RHN();
  if(p.needs)p.needs.forEach(function(n){var key=n&&n.v?n.v:n;var inp=document.getElementById('hn-'+key);if(inp&&n.note)inp.value=n.note;});
}

async function SAVPROJ(id){
  var n=document.getElementById('pn');if(!n||!n.value.trim())return;
  ...
  projs=projs.map(function(x){return x.id===id?Object.assign({},x,upd,{desc:upd.description}):x;});
...
function ROS(){
  ...
  if(!sl)return;sl.innerHTML='';
  if(!supporters.length){sl.innerHTML='<p style="font-size:12px;color:var(--mu);padding:8px 0;">Nog geen ondersteuners.</p>';return;}
  supporters.forEach(s=>{
    const card=document.createElement('div');card.className='card';card.style.cssText='padding:9px;margin-bottom:6px;';
    ...
    const eb=document.createElement('button');eb.textContent='Bewerk';eb.style.cssText='background:none;border:1px solid var(--g);border-radius:5px;cursor:pointer;color:var(--g);font-size:11px;padding:2px 6px;margin-right:4px;';
    eb.onclick=function(){EDSUPP(s.id);};
    const db=document.createElement('button');db.textContent='x';db.style.cssText='background:none;border:none;cursor:pointer;color:var(--co);font-size:16px;';
    db.onclick=function(){DELSUPP(s.id);};
    flex.appendChild(eb);flex.appendChild(db);sl.appendChild(card);
  });
}
function EDSUPP(id){
...
async function ADS(){
  ...
  if(_editSuppId){
    supporters=supporters.map(x=>String(x.id)===String(_editSuppId)?Object.assign({},x,entry,{id:x.id}):x);
...
async function saveMember(name,income,pct){if(!name||name==='Demo')return;try{await Promise.race([fetch(SURL+'/rest/v1/members',{method:'POST',headers:{'apikey':SKEY,'Authorization':'Bearer '+SKEY,'Content-Type':'application/json','Prefer':'resolution=merge-duplicates,return=minimal'},body:JSON.stringify({name:name,income:income,pct:Math.round(pct*100)})}),new Promise((_,r)=>setTimeout(()=>r('t'),5000))]);}catch(e){}try{const l=JSON.parse(localStorage.getItem('fs_members')||'[]');const i=l.findIndex(m=>m.name===name);if(i>=0)l[i]={name,income,pct:Math.round(pct*100)};else l.push({name,income,pct:Math.round(pct*100)});localStorage.setItem('fs_members',JSON.stringify(l));}catch(e){}}
async function loadRealMembers(){try{const r=await Promise.race([fetch(SURL+'/rest/v1/members?select=*&order=created_at.asc',{headers:{'apikey':SKEY,'Authorization':'Bearer '+SKEY}}),new Promise((_,rej)=>setTimeout(()=>rej('t'),5000))]);if(r&&r.ok){const d=await r.json();if(d&&d.length){realMembers=d;return;}}}catch(e){}try{const l=JSON.parse(localStorage.getItem('fs_members')||'[]');if(l.length)realMembers=l;}catch(e){}}
function PREVIEW(){const inc=+(mI&&mI.value)||0;const p=fx?(inc>0?(+(fa&&fa.value)||0)/inc:0):(+(ps&&ps.value)||0)/100;const mc=fx?(+(fa&&fa.value)||0):Math.round(inc*p);if(!fx&&$('pl'))$('pl').textContent=(ps?ps.value:10)+'% = €'+mc.toLocaleString('nl-NL')+'/mnd';}
function OPEN_APP(isDemo){try{const r=isDemo?[]:JSON.parse(localStorage.getItem('fs_removed')||'[]');mbrs=M.filter(m=>!r.includes(m.id));}catch(e){mbrs=[...M];}const wl=document.getElementById('wl');if(wl)wl.style.display='none';const ub=document.getElementById('ubar');if(ub)ub.style.display='flex';const ubn=document.getElementById('ubar-name');if(ubn)ubn.textContent=currentUser+(isDemo?' (demo)':'');if(!isDemo){try{const sv=localStorage.getItem('fs_inc_'+currentUser);if(sv){savedInc=+sv;if(mI)mI.value=sv;}const sp=localStorage.getItem('fs_pct_'+currentUser);if(sp)savedPct=+sp;}catch(e){}saveMember(currentUser,savedInc,savedPct);}if(isDemo&&mI&&!mI.value)mI.value='2500';PREVIEW();CS();ST(0);LD();try{$('st-s').textContent=shops.length;}catch(e){}}
function JOIN(){const n=document.getElementById('uname');if(!n||!n.value.trim())return;currentUser=n.value.trim();try{localStorage.setItem('fs_user',currentUser);}catch(e){}OPEN_APP(false);}
