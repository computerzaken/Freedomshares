...
{n:'Odin',c:'voeding',t:'cooperative',s:'hybrid',bio:5,fair:4,sust:4,lo:4,w:'https://www.odin.nl',d:'biologische supermarkt groente fruit zuivel brood eieren kaas boodschappen'},
...
{n:'Nudie Jeans',c:'kleding',t:'steward',s:'hybrid',bio:4,fair:5,sust:5,lo:2,w:'https://www.nudiejeans.com',d:'biologische jeans kleding duurzaam'},
...
{n:'ASN Bank',c:'financien',t:'steward',s:'online',bio:null,fair:5,sust:5,lo:4,w:'https://www.asnbank.nl',d:'duurzame bank sparen beleggen'},
{n:'Swapfiets',c:'mobiliteit',t:'steward',s:'physical',bio:null,fair:4,sust:4,lo:5,w:'https://www.swapfiets.nl',d:'fiets ebike abonnement'},
...
,{n:'Neighbours kitchen',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Almere',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'The black cockatoo',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Almere',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Bindi Café',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amersfoort',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Het lokaal',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amersfoort',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Rozey',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amersfoort',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Abu Amr Koshari',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Bloem eten & drinken',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Bonboon',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Café de Ceuvel',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Flower burger',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Café Gilde',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Have a roll',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Hearth',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Kitchen Impossible',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Koffie ende koeck',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Lait de Choco',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Little Plant Pantry',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Lowlander',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Luminair',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Madre',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Margo’s',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Meatless District',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'The Meets',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Mediamatic',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Men impossible',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'MKZ',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Morris & Bella',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Mr Watson',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'The Old Soul',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Oliver Green',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Robin Food',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Rose & Vanilla',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Saint-Jean',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De Sering',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Soil',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Spirit',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Sue',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'TerraZen Centre',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Trevi’s',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Vegan Junk Food Bar',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Vegan sushi bar',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Veganees',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De Waaghals',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Wrap Lab',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Amsterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'FLFL',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Arnhem',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Konijnenvoer',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Arnhem',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Puur Sahn',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Berg en Dal',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Loff',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Breda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Black & White kafe',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Breda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Den Bosch',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Breda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'FRET',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Breda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Pollevie',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Breda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'FOAM',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Den Haag',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Hagedis',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Den Haag',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'PLENTY',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Den Haag',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Vegane glorie',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Den Haag',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Veggies on fire',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Den Haag',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Hotel Gaia',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Deventer',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Rebel Rebel',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Dordrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Jungle',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Eindhoven',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Foodbar RAUW',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Enschede',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Het Paradijs',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Enschede',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Miss Nice Banana',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Gouda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Curcuma',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Gouda',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Achterwerk',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Blabla',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Fankaasoo',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Mahalo',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De Herbivoor',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Rå',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Smaakaron',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'SLA (I Love Sla)',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Groningen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'New Vegas',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Haarlem',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Mama Gaia',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Haarlem',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Klein Geluk',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Heemskerk',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Hoek van Holland',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Heemskerk',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Pele Surf Shack',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Heemskerk',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Leeuwarden',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Heemskerk',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Dr. Plant',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Heemskerk',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Lab071',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Logica',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Maastricht',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Avantgarde',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Soup Bros',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Bar Verde',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Leiden',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Bhalu',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Nijmegen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De nieuwe winkel',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Nijmegen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De Plak',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Nijmegen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'De Grote Broek',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Nijmegen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Tati',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Nijmegen',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Aloha bar',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Backyard',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Copperbranch',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Dumbo',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Gare du Nord',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Happy food and health',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Heavenly Cupcakes',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Leaf',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Sharp Sharp',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Vegan pizzabar',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Rotterdam',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Groenten van Roos',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Sittard',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Sint Geertruid',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Sittard',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Breakaway',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Sittard',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Texel, Den Burg',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Sittard',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Wit-lof Foodbar',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Sittard',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Broei',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Gys',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Kasvio',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Koffiebar en vegan bakkerij Kluts',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Last Vegas',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Le Jardin',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Life’s a peach',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Oproer',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Syr',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Vegitalian',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Warmoes',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Werkendam',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Zo’ndag Werkendam',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Utrecht',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
,{n:'Ministerie van geluk',c:'horeca',t:'retailer',s:'physical',bio:4,fair:4,sust:5,lo:5,p:'Zoetermeer',d:'vegan plantbased restaurant eten',certs:['vegan'],w:'https://www.eet.nu'}
];
const TX={wasmachine:{c:['witgoed']},droger:{c:['witgoed']},koelkast:{c:['witgoed']},ijskast:{c:['witgoed']},laptop:{c:['tech']},telefoon:{c:['tech']},smartphone:{c:['tech']},jeans:{c:['kleding']},broek:{c:['kleding']},shirt:{c:['kleding']},kleding:{c:['kleding']},shampoo:{c:['verzorging']},zeep:{c:['verzorging']},tandpasta:{c:['verzorging']},wasmiddel:{c:['verzorging']},schoonmaak:{c:['verzorging']},energie:{c:['energie']},stroom:{c:['energie']},zonnepanelen:{c:['energie']},fiets:{c:['mobiliteit']},ebike:{c:['mobiliteit']},bank:{c:['financien']},sparen:{c:['financien']},bouw:{c:['bouw']},software:{c:['tech']},advies:{c:['diensten']},media:{c:['media']},zorg:{c:['zorg']},eieren:{c:['voeding','markt']},ei:{c:['voeding','markt']},groente:{c:['voeding','markt']},groenten:{c:['voeding','markt']},doperwten:{c:['voeding','markt']},erwten:{c:['voeding','markt']},spinazie:{c:['voeding','markt']},tomaat:{c:['voeding','markt']},paprika:{c:['voeding','markt']},ui:{c:['voeding','markt']},wortel:{c:['voeding','markt']},broccoli:{c:['voeding','markt']},pompoen:{c:['voeding','markt']},courgette:{c:['voeding','markt']},sla:{c:['voeding','markt']},komkommer:{c:['voeding','markt']},aardappel:{c:['voeding','markt']},fruit:{c:['voeding','markt']},appel:{c:['voeding','markt']},appels:{c:['voeding','markt']},peer:{c:['voeding','markt']},banaan:{c:['voeding','markt']},aardbei:{c:['voeding','markt']},sinaasappel:{c:['voeding','markt']},melk:{c:['voeding','markt']},zuivel:{c:['voeding','markt']},yoghurt:{c:['voeding']},kaas:{c:['voeding','markt']},boter:{c:['voeding','markt']},vlees:{c:['voeding','markt']},kip:{c:['voeding','markt']},gehakt:{c:['voeding','markt']},vis:{c:['voeding','markt']},zalm:{c:['voeding','markt']},brood:{c:['voeding','markt']},bakker:{c:['voeding','markt']},pasta:{c:['voeding']},rijst:{c:['voeding']},bonen:{c:['voeding','markt']},linzen:{c:['voeding']},noten:{c:['voeding']},olie:{c:['voeding']},honing:{c:['voeding','markt']},chocolade:{c:['voeding']},koffie:{c:['voeding','horeca']},thee:{c:['voeding']},wijn:{c:['voeding','horeca']},bier:{c:['voeding','horeca']},supermarkt:{c:['voeding']},boodschappen:{c:['voeding','markt']},biologisch:{c:['voeding','markt','horeca']},boerenmarkt:{c:['markt']},boerderij:{c:['markt']},seizoensgroente:{c:['markt']},restaurant:{c:['horeca']},eten:{c:['horeca','voeding']},diner:{c:['horeca']},lunch:{c:['horeca']},cafe:{c:['horeca']},vegan:{c:['horeca']},horeca:{c:['horeca']},luiers:{c:['verzorging']}};
const OSC=[
...
var currentUser=null;var projs=[];var supporters=[];var fundpot=0;var fund=[];var realMembers=[];let mbrs=[...M],shops=[...SH_DATA];
...
function CS(){
  ...
  const all=[...demoMbrs,...realMbrs,{id:0,n:currentUser||'Jij',i:inc,me:true}];
  const pool=all.reduce((s,m)=>s+Math.round(m.i*(m.me?pct:(m.p!==undefined?m.p/100:0.10))),0),pp=all.length?Math.round(pool/all.length):0;
  const comp=all.map(m=>({...m,cn:Math.round(m.i*(m.me?pct:(m.p!==undefined?m.p/100:0.10))),rc:pp,nt:pp-Math.round(m.i*(m.me?pct:(m.p!==undefined?m.p/100:0.10)))}));
...
function RM(id){mbrs=mbrs.filter(m=>m.id!==id);try{const r=JSON.parse(localStorage.getItem('fs_removed')||'[]');if(!r.includes(id)){r.push(id);localStorage.setItem('fs_removed',JSON.stringify(r));}}catch(e){}CS();}
...
async function SETPOT(){var v=prompt('Startbedrag (euro):');if(!v||isNaN(+v))return;if(_DB)await _DB.from('fund_pot').update({startbedrag:+v}).gt('id',0);fundpot=+v;RH();}
...
async function LD(){if(!_DB)return;const{data:pd}=await _DB.from('projects').select('*').order('created_at',{ascending:false});if(pd)projs=pd.map(p=>({...p,desc:p.description}));const{data:sd}=await _DB.from('supporters').select('*').order('created_at',{ascending:false});if(sd&&sd.length){supporters=sd;}else{try{const ls=localStorage.getItem('fs_sup');if(ls)supporters=JSON.parse(ls);}catch(e){}}const{data:fd}=await _DB.from('fund').select('*');if(fd)fund=fd;const{data:fp}=await _DB.from('fund_pot').select('*').limit(1);if(fp&&fp[0])fundpot=+fp[0].startbedrag;if(sd&&sd.length){supporters=sd;}else{try{const ls=localStorage.getItem('fs_sup');if(ls)supporters=JSON.parse(ls);}catch(e){}}await loadRealMembers();RH();ROS();CS();let d=document.getElementById('h-debug');if(d&&pd)d.innerHTML='✅ '+pd.length+' project(en) geladen';}
...
async function saveMember(name,income,pct){
  ...
  try{
    await Promise.race([
      fetch(SURL+'/rest/v1/members',{
        ...
        body:JSON.stringify({name:name,income:income,pct:Math.round(pct*100)})
      }),
  ...
  // Also save locally
  try{
    const local=JSON.parse(localStorage.getItem('fs_members')||'[]');
    const idx=local.findIndex(m=>m.name===name);
    if(idx>=0)local[idx]={name,income,pct:Math.round(pct*100)};
    else local.push({name,income,pct:Math.round(pct*100)});
    localStorage.setItem('fs_members',JSON.stringify(local));
  }catch(e){}
}
...
async function loadRealMembers(){
  try{
    const r=await Promise.race([
      fetch(SURL+'/rest/v1/members?select=*&order=created_at.asc',{
  ...
  try{
    const local=JSON.parse(localStorage.getItem('fs_members')||'[]');
    if(local.length)realMembers=local;
  }catch(e){}
}
...
function OPEN_APP(isDemo){
  ...
  if(currentUser&&currentUser!=='Demo')saveMember(currentUser,+(mI&&mI.value)||0,0.10);
  CS();ST(0);LD();
}
...
function EDPROJ(id){
  ...
  f.innerHTML='<div class="card" style="border:1px solid #5b4fa8;"><h3 style="font-size:13px;margin-bottom:10px;color:#5b4fa8;">&#9998; Project bewerken</h3>'
    ...
    +'<button onclick="document.getElementById(\'hf\').style.display=\'none\';" style="padding:8px 12px;border-radius:8px;border:1px solid var(--br);background:none;font-size:11px;cursor:pointer;">Annuleren</button>'
    +'</div></div>';
  RHN();
...
async function SAVPROJ(id){
  ...
  Promise.resolve(_DB.from('projects').update(upd).eq('id',id)).catch(()=>{});
  projs=projs.map(function(x){return x.id===id?{...x,...upd,desc:upd.description}:x;});
